...
<html lang="es">
    ...
    <head>
        ...
        <title><?php echo $perfil_usuario; ?> - GeoSnap</title>
    ...
    <body>
      ...
      <nav class="navbar border-bottom fixed-top bg-white">
            <div class="container-fluid">
                <a class="navbar-brand text-primary logo" href="index.php">GeoSnap</a>
      ...
      <div class="contenedor">
        ...
        <div class="flex-column flex-shrink-0 border-end sidebar-corto" style="width: 4.5rem;">
          <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
              <a href="perfil.php" class="nav-link link-dark py-3" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Customers">
                    ...
                    <div class="d-flex align-items-start mb-4">
                      ...
                      ?>
                        ...
                        <div class="d-flex flex-column ms-4">
                            <h4 class="fw-bold"><?php echo $perfil_usuario ?></h4>
                            <span class="fw-medium mb-4"><?php echo $nombre . " " . $apellidos ?></span>

                            <?php
                                $stmt = $conexion->prepare("SELECT * FROM seguidos WHERE nombre_usuario_seguido=? AND nombre_usuario=?");
                                $stmt->bind_param("ss", $perfil_usuario, $_COOKIE["usuario"]);
                                $stmt->execute();
                            ...
                            <a class="btn btn-outline-danger text-center px-4" href="php/dejar-seguir.php?usuario=<?php echo $perfil_usuario; ?>" role="button" style="max-width: 200px;">Dejar de seguir</a>
                            ...
                            <form action="php/seguir.php" method="post">
                              <button type="submit" value="<?php echo $perfil_usuario; ?>" name="usuario" class="btn btn-outline-primary text-center px-4" style="max-width: 200px;">Seguir</button>
                            </form>
        ...
        <div class="modal fade" id="siguiendo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Personas que sigue <?php echo $perfil_usuario ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
        ...
        <div class="modal fade" id="seguidores" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Personas que siguen a <?php echo $perfil_usuario ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <?php
