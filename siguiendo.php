...
<html lang="es">
    ...
    <head>
        ...
        <title>Siguiendo - Mira publicaciones de las personas que sigues</title>
      ...
      <div class="contenedor">
        ...
        <div class="flex-column flex-shrink-0 border-end sidebar-corto" style="width: 4.5rem;">
          <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
            ...
            <li>
              <a href="siguiendo.php" class="nav-link py-3" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Dashboard">
        ...
        <div class="main-body">
          ...
          <?php
              ...
              if(mysqli_num_rows($result) > 0) {
                while($fila = mysqli_fetch_assoc($result)) {
                  $id_usuario_seguido = $fila["id_usuario_seguido"];
                  $nombre_usuario_seguido = $fila["nombre_usuario_seguido"];

                  $stmt = $conexion->prepare("SELECT * FROM publicaciones WHERE id_usuario=? ORDER BY id DESC");
                  $stmt->bind_param("i", $id_usuario_seguido);
                  $stmt->execute();

                  $result_publicaciones = $stmt->get_result();

                  while($fila_publicaciones = mysqli_fetch_assoc($result_publicaciones)) {
                    $id_publicacion = $fila_publicaciones["id"];
                    $publicacion = $fila_publicaciones["archivo"];
                    $ubicacion = $fila_publicaciones["ubicacion"];
                    $descripcion = $fila_publicaciones["descripcion"];
                    $fecha = $fila_publicaciones["fecha"];
                    $likes = $fila_publicaciones["likes"];
                    $num_comentarios = $fila_publicaciones["num_comentarios"];
          ?>
          ...
          <div class="card border-bottom rounded-0 my-4" style="width: 600px; border: none;">
            <div class="d-flex mb-3">
              ...
              <?php
                ...
                $result_foto_perfil = $stmt->get_result();

                while($fila_foto_perfil = mysqli_fetch_assoc($result_foto_perfil)) {
              ...
              <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario_seguido; ?>" class="d-flex align-items-center"><img src="img/person-circle.svg" class="me-2 rounded-circle img-perfil-post" style="width: 40px; height: 40px;"></a>
              
              <?php
                } else {
              ?>

              <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario_seguido; ?>" class="d-flex align-items-center"><img src="img/<?php echo $foto_perfil; ?>" class="me-2 rounded-circle img-perfil-post" style="width: 40px; height: 40px;"></a>
              ...
              <div class="d-flex flex-column">
                <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario_seguido; ?>" class="fw-bold text-decoration-none text-dark"><?php echo $nombre_usuario_seguido; ?></a>
            ...
            <img src="img/<?php echo $publicacion; ?>" class="card-img-top rounded-2" alt="publicacion de prueba">
            <div class="card-body px-1 py-0 mt-1">
              ...
              <div class="my-2">
                <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario_seguido; ?>" class="text-dark text-decoration-none fw-bold me-2"><?php echo $nombre_usuario_seguido; ?></a><span><?php echo $descripcion; ?></span>
              </div>
              <div class="my-4">
          ...
          ?>
          <p class="fw-bold text-center mt-5">No sigues a nadie</p>
          <p class="text-secondary text-center">Ve a <a href="explorar.php" class="text-dark fw-bold ve-a-explorar">Explorar</a> y empieza a conocer gente y lugares nuevos</p>
          <?php
              }
          ?>
        </div>
