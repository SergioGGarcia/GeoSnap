...
<html lang="es">
    ...
    <head>
        ...
        <title>Explorar - Encuentra tu lugar favorito</title>
    ...
    <body>
      ...
      <div class="contenedor">
        ...
        <div class="main-body px-5">
          <div>
            <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="get" class="d-flex flex-wrap mt-4">
              <?php
                $etiquetas = ["Montaña", "Playa", "Parque", "Rio", "Lago", "Museo", "Catedral", "Palacio", "Restaurante", "Bar", "Discoteca"];
                foreach ($etiquetas as $index => $etiqueta) {
                    $id = "option" . ($index + 1);
                    $labelId = strtolower($etiqueta);
                    echo "
                    <input type='submit' class='btn-check' name='etiqueta' value='$etiqueta' id='$id' autocomplete='off'>
                    <label class='btn btn-secondary me-2 mb-2 border-0 text-dark btn-explorar' for='$id' id='$labelId'>$etiqueta</label>
                    ";
                }
              ?>
            </form>
            ...
            <div class="contenido-explorar my-4">
              ...
              <?php
                if (isset($_GET["etiqueta"])) {
                  ...
                  $stmt = $conexion->prepare("SELECT * FROM publicaciones WHERE etiqueta=? ORDER BY id DESC");
                  ...
                  if(mysqli_num_rows($result) > 0) {
                    while($fila = mysqli_fetch_assoc($result)) {
                      ...
                      $result_usuario = mysqli_query($conexion, $sql);
              ...
              <div class="card" style="width: 100%; height: 400px; border: none;">
                <button type="button" class="border-0" id="btn-publicacion" style="width: 100%; height: 400px;" data-bs-toggle="modal" data-bs-target="#publicacion-<?php echo $publicacion; ?>" data-id="<?php echo $id_publicacion; ?>" data-publicacion="<?php echo $publicacion; ?>" data-likes="<?php echo $likes; ?>" data-comentarios="<?php echo $num_comentarios; ?>" data-nombre="<?php echo $nombre_usuario; ?>" data-descripcion="<?php echo $descripcion; ?>" data-fecha="<?php echo $fecha; ?>" data-ubicacion="<?php echo $ubicacion; ?>"><img src="img/<?php echo $publicacion; ?>" class="card-img-top rounded-bottom" style="width: 100%; height: 100%; object-fit: cover;" alt="Publicación: <?php echo $descripcion; ?>"></button>
                <div class="card-body d-flex flex-column p-2">
                  ...
                  <div class="d-flex mt-2">
                    ...
                    <a href="perfil.php"><img src="img/person-circle.svg" class="me-1 img-perfil-post-explorar rounded-circle" style="width: 25px; height: 25px;"></a>
                    <a href="perfil.php" class="text-dark text-decoration-none fw-bold me-2"><?php echo $nombre_usuario; ?></a>

                    <?php
                        } else {
                    ?>

                    <a href="perfil.php"><img src="img/<?php echo $foto_perfil; ?>" class="me-1 img-perfil-post-explorar rounded-circle" style="width: 25px; height: 25px;"></a>
                    <a href="perfil.php" class="text-dark text-decoration-none fw-bold me-2"><?php echo $nombre_usuario; ?></a>
                    ...
                    <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario; ?>"><img src="img/person-circle.svg" class="me-1 img-perfil-post-explorar rounded-circle" style="width: 25px; height: 25px;"></a>
                    <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario; ?>" class="text-dark text-decoration-none fw-bold me-2"><?php echo $nombre_usuario; ?></a>

                    <?php
                        } else {
                    ?>

                    <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario; ?>"><img src="img/<?php echo $foto_perfil; ?>" class="me-1 img-perfil-post-explorar rounded-circle" style="width: 25px; height: 25px;"></a>
                    <a href="perfil-otro.php?usuario=<?php echo $nombre_usuario; ?>" class="text-dark text-decoration-none fw-bold me-2"><?php echo $nombre_usuario; ?></a>
                    ...
                    <div class="ms-auto">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" id="mg_<?php echo $id_publicacion; ?>" class="bi bi-heart" viewBox="0 0 16 16">
                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                      </svg>
                      <span id="like_<?php echo $id_publicacion; ?>"><?php echo $likes; ?></span>

                      <?php
                        } else {
                      ?>

                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" id="mg_<?php echo $id_publicacion; ?>" class="bi bi-heart" viewBox="0 0 16 16">
                        <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
                      </svg>
                      <span id="like_<?php echo $id_publicacion; ?>"><?php echo $likes; ?></span>
              ...
              <!-- Modal publicacion -->
              <div class="modal fade" id="publicacion-<?php echo $publicacion; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="--bs-modal-width: 1000px;">
              ...
              <?php
                  ...
                  $stmt = $conexion->prepare("SELECT * FROM publicaciones WHERE etiqueta='montaña' ORDER BY id DESC");
                  $stmt->execute();
              ...
              <div class="card" style="width: 100%; height: 400px; border: none;">
                <button type="button" class="border-0" id="btn-publicacion" style="width: 100%; height: 400px;" data-bs-toggle="modal" data-bs-target="#publicacion-<?php echo $id_publicacion; ?>" data-ubicacion="<?php echo $ubicacion; ?>" data-id="<?php echo $id_publicacion; ?>" data-publicacion="<?php echo $publicacion; ?>" data-likes="<?php echo $likes; ?>" data-comentarios="<?php echo $num_comentarios; ?>" data-nombre="<?php echo $nombre_usuario; ?>" data-descripcion="<?php echo $descripcion; ?>" data-fecha="<?php echo $fecha; ?>"><img src="img/<?php echo $publicacion; ?>" class="card-img-top rounded-bottom" style="width: 100%; height: 100%; object-fit: cover;" alt="Publicación: <?php echo $descripcion; ?>"></button>
                <div class="card-body d-flex flex-column p-2">
                  <p class="card-text text-nowrap overflow-hidden"><?php echo $descripcion; ?></p>
                  <div class="d-flex mt-2">
      ...
      <script>
        // Botones de la sección explorar

        document.addEventListener("DOMContentLoaded", function () {
          const buttons = document.querySelectorAll(".btn-explorar");

          // Check localStorage for selected button
          const selectedButton = localStorage.getItem("selectedButton");
          if (selectedButton) {
            document.getElementById(selectedButton).classList.add("bg-secondary", "text-white");
          } else {
            document.getElementById("montaña").classList.add("bg-secondary", "text-white");
          }
